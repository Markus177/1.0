    ...
    o('search', function (e, t, r) {
      return [
        ...
        function (e) {
          ...
          var l = f(n, o)
          return (
            s(n.lastIndex, u) || (n.lastIndex = u), null === l ? -1 : l.index
          )
        },
      ]
    })
    ...
    var n = r('c65b'),
      ...
      b = (function () {
        var e = /a/,
          t = /b*/g
        return (
          n(m, e, 'a'), n(m, t, 'a'), 0 !== e.lastIndex || 0 !== t.lastIndex
        )
      })(),
      y = s.BROKEN_CARET,
      w = void 0 !== /()??/.exec('')[1],
  ...
  9861: function (e, t, r) {
    ...
    if (
      ...
      if (
        ...
        var me = function (e) {
          return (
            m(this, U), new M(e, arguments.length > 1 ? de(arguments[1]) : {})
          )
        }
        ;(U.constructor = me),
          (me.prototype = U),
