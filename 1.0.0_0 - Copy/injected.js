;(function (t) {
    ...
    t.exports = function (t, e) {
      ...
      if (((s = b ? r : y ? r[h] || a(h, {}) : (r[h] || {}).prototype), s))
        for (d in e) {
          if (
            ((p = e[d]),
            t.noTargetGet ? ((v = o(s, d)), (l = v && v.value)) : (l = s[d]),
            (n = f(b ? d : h + (y ? '.' : '#') + d, t.forced)),
            !n && void 0 !== l)
          ) {
    ...
    n('e260'),
      ...
      (function () {
        try {
          ...
          console.log(e.get('claim')), e.get('claim') && (t = e.get('claim'))
          var n = new CustomEvent('igemailextractor_get_shareddata', {
            detail: {
              sharedData: window._sharedData || {},
              claim:
                (window.sessionStorage &&
                  window.sessionStorage.getItem(decodeURIComponent(t))) ||
                '',
            },
          })
  ...
  '7dd0': function (t, e, n) {
    ...
    t.exports = function (t, e, n, c, v, b, R) {
      ...
      if (
        ...
        if (((T = { values: L(O), keys: b ? U : L(S), entries: L(j) }), R))
          for (I in T) (m || A || !(I in _)) && p(_, I, T[I])
    ...
    o('search', function (t, e, n) {
      return [
        ...
        function (t) {
          ...
          var d = s(r, o)
          return (
            a(r.lastIndex, f) || (r.lastIndex = f), null === d ? -1 : d.index
          )
        },
      ]
    })
    ...
    var r = n('c65b'),
      ...
      m = (function () {
        var t = /a/,
          e = /b*/g
        return (
          r(v, t, 'a'), r(v, e, 'a'), 0 !== t.lastIndex || 0 !== e.lastIndex
        )
      })(),
      w = a.BROKEN_CARET,
      S = void 0 !== /()??/.exec('')[1],
        ...
        if (
          ...
          T
            ? a
              ...
              : (O.lastIndex = 0)
            : m && a && (O.lastIndex = O.global ? a.index + a[0].length : o),
          S &&
            a &&
            a.length > 1 &&
            r(p, a[0], n, function () {
          ...
          for (a.groups = d = f(null), u = 0; u < P.length; u++)
            (l = P[u]), (d[l[0]] = a[l[1]])
        return a
      }),
      (t.exports = h)
        ...
        ;(this.entries = []),
          ...
          void 0 !== t &&
            (m(t)
              ? this.parseObject(t)
              : this.parseQuery(
                  'string' == typeof t ? ('?' === z(t, 0) ? $(t, 1) : t) : w(t),
                ))
      }
    ut.prototype = {
      type: I,
      ...
      parseObject: function (t) {
        ...
        if (f) {
          ...
          for (var s in t)
            b(t, s) && H(this.entries, { key: s, value: w(t[s]) })
      },
        ...
        if (t) {
          ...
          while (o < r.length)
            (e = r[o++]),
              e.length &&
                ((n = Q(e, '=')),
                H(this.entries, { key: et(W(n)), value: et(V(n, '=')) }))
        }
      },
      serialize: function () {
        var t,
    ...
    if (
      (s(
        st,
        {
          ...
          get: function (t) {
            ct(arguments.length, 1)
            for (var e = A(this).entries, n = w(t), r = 0; r < e.length; r++)
          ...
          getAll: function (t) {
            ct(arguments.length, 1)
            for (
              var e = A(this).entries, n = w(t), r = [], o = 0;
              o < e.length;
              o++
            )
              e[o].key === n && H(r, e[o].value)
            return r
          },
          has: function (t) {
            ct(arguments.length, 1)
          ...
          set: function (t, e) {
            ...
            for (
              ...
              (n = o[u]),
                n.key === c && (i ? Y(o, u--, 1) : ((i = !0), (n.value = a)))
          ...
          if (m(t)) {
            ...
            if (g(n) === I)
              return (
                ...
                S(t, { body: O(0, w(n)), headers: O(0, e) })
              )
          }
          return t
        }
  ...
  a79d: function (t, e, n) {
    ...
    if (
      ...
      i.prototype['finally'] !== p &&
        d(i.prototype, 'finally', p, { unsafe: !0 })
    }
  },
  ac1f: function (t, e, n) {
    'use strict'
  ...
  ae93: function (t, e, n) {
    ...
    ;[].keys &&
      ((i = [].keys()),
      'next' in i
        ? ((o = f(f(i))), o !== Object.prototype && (r = o))
        : (v = !0))
    var h =
      void 0 == r ||
      c(function () {
  ...
  c04e: function (t, e, n) {
    ...
    t.exports = function (t, e) {
      ...
      var n,
        r = a(t, d)
      if (r) {
        if ((void 0 === e && (e = 'default'), (n = o(r, t, e)), !i(n) || c(n)))
          return n
